...
const _sfc_main = /* @__PURE__ */ vueExports.defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[--><div class="employee-page" data-v-ba59d1ff><h1 class="employee-title" data-v-ba59d1ff>Employee Management</h1><form class="employee-search" data-v-ba59d1ff>`);
      ...
      _push(`</div></div></form><div class="form-divider" aria-hidden="true" data-v-ba59d1ff></div><div class="employees-table-wrap" data-v-ba59d1ff><table class="employees-table"${serverRenderer_cjs_prodExports.ssrRenderAttr("aria-busy", isTableLoading.value ? "true" : "false")} data-v-ba59d1ff><thead data-v-ba59d1ff><tr data-v-ba59d1ff><th data-v-ba59d1ff>Employee Name</th><th data-v-ba59d1ff>Department</th><th data-v-ba59d1ff>ID Card</th><th class="actions-column" data-v-ba59d1ff>Actions</th></tr></thead><tbody data-v-ba59d1ff>`);
      if (isTableLoading.value) {
        _push(`<tr class="loading-row" role="status" aria-live="polite" data-v-ba59d1ff><td class="loading-cell" colspan="4" data-v-ba59d1ff><div class="loading-content" data-v-ba59d1ff><span class="table-spinner" aria-hidden="true" data-v-ba59d1ff></span><span data-v-ba59d1ff>Loading employees...</span></div></td></tr>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<!--[-->`);
      serverRenderer_cjs_prodExports.ssrRenderList(isTableLoading.value ? [] : filteredEmployees.value, (employee) => {
        _push(`<tr data-v-ba59d1ff><td data-v-ba59d1ff>${serverRenderer_cjs_prodExports.ssrInterpolate(employee.name)}</td><td data-v-ba59d1ff>${serverRenderer_cjs_prodExports.ssrInterpolate(employee.department)}</td><td data-v-ba59d1ff>`);
        ...
        _push(`</td><td data-v-ba59d1ff><div class="action-buttons" data-v-ba59d1ff><button type="button" class="action-button action-button--view"${serverRenderer_cjs_prodExports.ssrRenderAttr("aria-label", `View ${employee.name}`)} data-v-ba59d1ff>`);
      ...
      _push(`<!--]--></tbody></table></div><button type="button" class="floating-add-button" aria-label="Add employee" data-v-ba59d1ff>`);
      ...
      if (props.showSuccessAlert) {
        _push(`<div class="success-alert-container" data-v-ba59d1ff>`);
      ...
      _push(serverRenderer_cjs_prodExports.ssrRenderComponent(Modal, {
        ...
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="delete-modal" data-v-ba59d1ff${_scopeId}><p class="delete-modal__text" data-v-ba59d1ff${_scopeId}>Are you sure you want to delete?</p><div class="delete-modal__actions" data-v-ba59d1ff${_scopeId}><button type="button" class="delete-modal__button delete-modal__button--subtle" data-v-ba59d1ff${_scopeId}> No </button><button type="button" class="delete-modal__button delete-modal__button--danger" data-v-ba59d1ff${_scopeId}> Yes, Delete </button></div></div>`);
          } else {
            return [
      ...
      _push(serverRenderer_cjs_prodExports.ssrRenderComponent(Modal, {
        ...
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="delete-loading-modal" data-v-ba59d1ff${_scopeId}><span class="delete-loading-modal__spinner" aria-hidden="true" data-v-ba59d1ff${_scopeId}></span><p class="delete-loading-modal__text" data-v-ba59d1ff${_scopeId}>Deleting Employee</p></div>`);
          } else {
            return [
...
const Employee = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ba59d1ff"]]);

export { Employee as default };
//# sourceMappingURL=employee-DwXdMpJ3.mjs.map
