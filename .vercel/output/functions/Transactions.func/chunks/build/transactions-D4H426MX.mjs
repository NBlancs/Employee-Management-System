...
const _sfc_main = /* @__PURE__ */ vueExports.defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${serverRenderer_cjs_prodExports.ssrRenderAttrs(vueExports.mergeProps({ class: "transaction-page" }, _attrs))} data-v-8ecd5aab><h1 class="transaction-title" data-v-8ecd5aab>Transaction Management</h1><form class="transaction-search" data-v-8ecd5aab><div class="search-input-wrap" data-v-8ecd5aab>`);
      ...
      if (searchQuery.value) {
        _push(`<button type="button" class="clear-search-btn" aria-label="Clear search" data-v-8ecd5aab>`);
      ...
      _push(`<div class="date-field" data-v-8ecd5aab><input id="transaction-date"${serverRenderer_cjs_prodExports.ssrRenderAttr("value", selectedDate.value)} type="date" class="date-input" aria-label="Filter by transaction date" data-v-8ecd5aab>`);
      if (selectedDate.value) {
        _push(`<button type="button" class="clear-date-button" data-v-8ecd5aab> Clear </button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></form><div class="form-divider" aria-hidden="true" data-v-8ecd5aab></div><div class="transactions-table-wrap" data-v-8ecd5aab>`);
...
const Transactions = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8ecd5aab"]]);

export { Transactions as default };
//# sourceMappingURL=transactions-D4H426MX.mjs.map
