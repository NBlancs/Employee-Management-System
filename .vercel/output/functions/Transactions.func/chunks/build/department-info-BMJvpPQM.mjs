...
const _sfc_main = /* @__PURE__ */ vueExports.defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${serverRenderer_cjs_prodExports.ssrRenderAttrs(vueExports.mergeProps({ class: "department-info-page" }, _attrs))} data-v-1b85b52f><div class="top-alert-wrap" data-v-1b85b52f>`);
      ...
      _push(`</div><div class="department-info-header" data-v-1b85b52f><button type="button" class="back-button" aria-label="Back" data-v-1b85b52f>`);
      _push(serverRenderer_cjs_prodExports.ssrRenderComponent(vueExports.unref(ArrowLeftIcon), { class: "back-icon" }, null, _parent));
      _push(`</button><h1 class="department-info-title" data-v-1b85b52f>Department Details</h1></div><div class="department-cards-grid" data-v-1b85b52f><section class="department-info-card" aria-label="Department information" data-v-1b85b52f><div class="department-detail-row" data-v-1b85b52f><div class="department-detail-item" data-v-1b85b52f><p class="department-detail-label" data-v-1b85b52f>Department Name</p><p class="department-detail-value" data-v-1b85b52f>${serverRenderer_cjs_prodExports.ssrInterpolate(activeDepartment.value?.name || "-")}</p></div><div class="department-detail-item department-detail-item--with-button" data-v-1b85b52f><p class="department-detail-label" data-v-1b85b52f>Department Head</p><div class="department-head-value-wrap" data-v-1b85b52f><p class="department-detail-value" data-v-1b85b52f>${serverRenderer_cjs_prodExports.ssrInterpolate(activeDepartment.value?.head || "-")}</p></div></div></div></section>`);
      ...
      _push(`</div><div class="department-divider" aria-hidden="true" data-v-1b85b52f></div><form class="department-search" data-v-1b85b52f>`);
      ...
      _push(`</form><div class="positions-table-wrap" data-v-1b85b52f>`);
      _push(serverRenderer_cjs_prodExports.ssrRenderComponent(Table, {
        ...
        "action-cell": vueExports.withCtx(({ row }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="table-actions" data-v-1b85b52f${_scopeId}><button type="button" class="table-action-button update" aria-label="Update position" title="Update" data-v-1b85b52f${_scopeId}>`);
            ...
            _push2(`</button><button type="button" class="table-action-button delete" aria-label="Delete position" title="Delete" data-v-1b85b52f${_scopeId}>`);
      ...
      _push(`</div><button type="button" class="fab-add-position" aria-label="Add position" title="Add Position" data-v-1b85b52f>`);
      ...
      _push(serverRenderer_cjs_prodExports.ssrRenderComponent(Modal, {
        ...
        header: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h3 class="modal-title" data-v-1b85b52f${_scopeId}>Update Salary</h3>`);
          } else {
            return [
        ...
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="modal-form-field" data-v-1b85b52f${_scopeId}><p class="update-position-text" data-v-1b85b52f${_scopeId}>Position: ${serverRenderer_cjs_prodExports.ssrInterpolate(selectedUpdatePosition.value)}</p><label class="modal-field-label" for="current-salary" data-v-1b85b52f${_scopeId}>Current Salary</label><div class="current-salary-display" data-v-1b85b52f${_scopeId}>${serverRenderer_cjs_prodExports.ssrInterpolate(selectedCurrentSalary.value || "-")}</div><div class="salary-option-grid" role="group" aria-label="Update salary selection" data-v-1b85b52f${_scopeId}>`);
            ...
            if (hasUpdateSalaryOptionError.value) {
              _push2(`<p class="modal-field-error" data-v-1b85b52f${_scopeId}>Please choose a salary update option</p>`);
            } else {
              _push2(`<!---->`);
            }
            if (isUpdateNewSalaryOptionChecked.value) {
              _push2(`<div class="modal-form-field" data-v-1b85b52f${_scopeId}><label class="modal-field-label" for="update-new-salary-amount" data-v-1b85b52f${_scopeId}>New Salary Amount</label>`);
              ...
              if (hasUpdateNewSalaryAmountError.value) {
                _push2(`<p class="modal-field-error" data-v-1b85b52f${_scopeId}>Please enter new salary amount</p>`);
              } else if (hasUpdateNewSalaryAmountFormatError.value) {
                _push2(`<p class="modal-field-error" data-v-1b85b52f${_scopeId}>Salary amount must be a valid number</p>`);
              } else if (hasUpdateNewSalaryDuplicateError.value) {
                _push2(`<p class="modal-field-error" data-v-1b85b52f${_scopeId}>This salary amount already exists. Use existing salary option instead.</p>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
      ...
      _push(serverRenderer_cjs_prodExports.ssrRenderComponent(Modal, {
        ...
        header: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h3 class="modal-title" data-v-1b85b52f${_scopeId}>New Position</h3>`);
          } else {
            return [
        ...
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="modal-form-field" data-v-1b85b52f${_scopeId}>`);
            _push2(serverRenderer_cjs_prodExports.ssrRenderComponent(Input, {
            ...
            if (hasPositionNameError.value) {
              _push2(`<p class="modal-field-error" data-v-1b85b52f${_scopeId}>Please enter position name</p>`);
            } else if (isDuplicatePositionNameError.value) {
              _push2(`<p class="modal-field-error" data-v-1b85b52f${_scopeId}>Position name is already registered</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<div class="salary-option-grid" role="group" aria-label="Salary option selection" data-v-1b85b52f${_scopeId}>`);
            _push2(serverRenderer_cjs_prodExports.ssrRenderComponent(CheckBox, {
            ...
            if (hasSalaryOptionError.value) {
              _push2(`<p class="modal-field-error" data-v-1b85b52f${_scopeId}>Please select one salary option</p>`);
            } else {
              _push2(`<!---->`);
            }
            if (isNewSalaryOptionChecked.value) {
              _push2(`<div class="modal-form-field" data-v-1b85b52f${_scopeId}><label class="modal-field-label" for="add-position-new-salary-amount" data-v-1b85b52f${_scopeId}>New Salary Amount</label>`);
              _push2(serverRenderer_cjs_prodExports.ssrRenderComponent(Input, {
            ...
            if (isCurrentSalaryOptionChecked.value) {
              _push2(`<div class="modal-form-field" data-v-1b85b52f${_scopeId}><label class="modal-field-label" for="add-position-current-salary" data-v-1b85b52f${_scopeId}>Current Salary Amount</label><select id="add-position-current-salary" class="modal-select"${serverRenderer_cjs_prodExports.ssrRenderAttr("aria-invalid", hasAddCurrentSalaryError.value ? "true" : "false")} style="${serverRenderer_cjs_prodExports.ssrRenderStyle(hasAddCurrentSalaryError.value ? { borderColor: "#ef4444", boxShadow: "0 0 0 3px rgba(239, 68, 68, 0.14)" } : void 0)}" data-v-1b85b52f${_scopeId}><option value="" data-v-1b85b52f${serverRenderer_cjs_prodExports.ssrIncludeBooleanAttr(Array.isArray(selectedCurrentSalaryForAdd.value) ? serverRenderer_cjs_prodExports.ssrLooseContain(selectedCurrentSalaryForAdd.value, "") : serverRenderer_cjs_prodExports.ssrLooseEqual(selectedCurrentSalaryForAdd.value, "")) ? " selected" : ""}${_scopeId}>Select current salary amount</option><!--[-->`);
              ...
              if (hasAddCurrentSalaryError.value) {
                _push2(`<p class="modal-field-error" data-v-1b85b52f${_scopeId}>Please select current salary amount</p>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
      ...
      _push(serverRenderer_cjs_prodExports.ssrRenderComponent(Modal, {
        ...
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p class="confirm-modal-text" data-v-1b85b52f${_scopeId}> Are you sure you want to add <span class="confirm-modal-position-name" data-v-1b85b52f${_scopeId}>&#39;${serverRenderer_cjs_prodExports.ssrInterpolate(newPositionName.value.trim())}&#39;</span>? </p>`);
          } else {
            return [
      ...
      _push(serverRenderer_cjs_prodExports.ssrRenderComponent(Modal, {
        ...
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="loading-modal-content" role="status" aria-live="polite" data-v-1b85b52f${_scopeId}><span class="table-spinner" aria-hidden="true" data-v-1b85b52f${_scopeId}></span><p class="adding-position-text" data-v-1b85b52f${_scopeId}>Adding new position</p></div>`);
          } else {
            return [
              vueExports.createVNode("div", {
      ...
      _push(serverRenderer_cjs_prodExports.ssrRenderComponent(Modal, {
        ...
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="loading-modal-content" role="status" aria-live="polite" data-v-1b85b52f${_scopeId}><span class="table-spinner" aria-hidden="true" data-v-1b85b52f${_scopeId}></span><p class="updating-salary-text" data-v-1b85b52f${_scopeId}>Updating ${serverRenderer_cjs_prodExports.ssrInterpolate(selectedUpdatePosition.value)} salary</p></div>`);
          } else {
            return [
              vueExports.createVNode("div", {
                class: "loading-modal-content",
      ...
      _push(serverRenderer_cjs_prodExports.ssrRenderComponent(Modal, {
        ...
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p class="confirm-modal-text" data-v-1b85b52f${_scopeId}> Are you sure you want to delete <span class="confirm-modal-position-name" data-v-1b85b52f${_scopeId}>${serverRenderer_cjs_prodExports.ssrInterpolate(selectedDeletePosition.value)}</span>? </p>`);
          } else {
            return [
              vueExports.createVNode("p", { class: "confirm-modal-text" }, [
      ...
      _push(serverRenderer_cjs_prodExports.ssrRenderComponent(Modal, {
        ...
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="loading-modal-content" role="status" aria-live="polite" data-v-1b85b52f${_scopeId}><span class="table-spinner" aria-hidden="true" data-v-1b85b52f${_scopeId}></span><p class="deleting-position-text" data-v-1b85b52f${_scopeId}>Deleting ${serverRenderer_cjs_prodExports.ssrInterpolate(selectedDeletePosition.value)} position</p></div>`);
          } else {
            return [
              vueExports.createVNode("div", {
                class: "loading-modal-content",
...
const DepartmentInfo = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1b85b52f"]]);

export { DepartmentInfo as default };
//# sourceMappingURL=department-info-BMJvpPQM.mjs.map
