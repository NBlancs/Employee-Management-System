...
const _sfc_main = /* @__PURE__ */ vueExports.defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${serverRenderer_cjs_prodExports.ssrRenderAttrs(vueExports.mergeProps({ class: "attendance-page" }, _attrs))} data-v-654a2e36><h1 class="attendance-title" data-v-654a2e36>Attendance Management</h1><form class="attendance-search" data-v-654a2e36><div class="date-field" data-v-654a2e36><label class="date-label" for="attendance-date" data-v-654a2e36>Select Date</label><input id="attendance-date"${serverRenderer_cjs_prodExports.ssrRenderAttr("value", selectedDate.value)} type="date" class="date-input" aria-label="Select attendance date" data-v-654a2e36></div>`);
      ...
      _push(serverRenderer_cjs_prodExports.ssrRenderComponent(Button, {
        ...
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<span data-v-654a2e36${_scopeId}>View Shift Hours</span>`);
          } else {
            return [
      ...
      _push(`</form><div class="attendance-divider" aria-hidden="true" data-v-654a2e36></div><div class="attendance-table-wrap" data-v-654a2e36><table class="attendance-table" data-v-654a2e36><thead data-v-654a2e36><tr data-v-654a2e36><th data-v-654a2e36>Department</th><th data-v-654a2e36>Total Employees</th><th data-v-654a2e36>Present</th><th data-v-654a2e36>Absent</th><th data-v-654a2e36>Late</th><th data-v-654a2e36>Leave</th><th data-v-654a2e36>Date</th><th class="actions-column" data-v-654a2e36>Action</th></tr></thead><tbody data-v-654a2e36><!--[-->`);
      serverRenderer_cjs_prodExports.ssrRenderList(filteredAttendanceRows.value, (row) => {
        _push(`<tr data-v-654a2e36><td data-v-654a2e36>${serverRenderer_cjs_prodExports.ssrInterpolate(row.department)}</td><td data-v-654a2e36>${serverRenderer_cjs_prodExports.ssrInterpolate(row.totalEmployees)}</td><td data-v-654a2e36>${serverRenderer_cjs_prodExports.ssrInterpolate(row.present)}</td><td data-v-654a2e36>${serverRenderer_cjs_prodExports.ssrInterpolate(row.absent)}</td><td data-v-654a2e36>${serverRenderer_cjs_prodExports.ssrInterpolate(row.late)}</td><td data-v-654a2e36>${serverRenderer_cjs_prodExports.ssrInterpolate(row.leave)}</td><td data-v-654a2e36>${serverRenderer_cjs_prodExports.ssrInterpolate(row.date)}</td><td data-v-654a2e36><button type="button" class="action-button action-button--view"${serverRenderer_cjs_prodExports.ssrRenderAttr("aria-label", `View ${row.department} attendance on ${row.date}`)} data-v-654a2e36>`);
      ...
      if (!filteredAttendanceRows.value.length) {
        _push(`<tr data-v-654a2e36><td colspan="8" class="empty-state" data-v-654a2e36>No attendance records found.</td></tr>`);
      } else {
        _push(`<!---->`);
      }
...
const Attendance = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-654a2e36"]]);

export { Attendance as default };
//# sourceMappingURL=attendance-CbZET-rh.mjs.map
