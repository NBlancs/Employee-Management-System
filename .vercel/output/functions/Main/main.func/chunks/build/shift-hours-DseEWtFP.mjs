...
const _sfc_main = /* @__PURE__ */ vueExports.defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[--><section class="shift-hours-page" data-v-949813ab>`);
      if (showSuccessAlert.value) {
        _push(`<div class="shift-hours-alert-wrap" data-v-949813ab>`);
      ...
      _push(`<div class="shift-hours-header" data-v-949813ab><button class="back-button" data-v-949813ab>`);
      _push(serverRenderer_cjs_prodExports.ssrRenderComponent(vueExports.unref(ArrowLeftIcon), { class: "back-icon" }, null, _parent));
      _push(`</button><h1 class="shift-hours-title" data-v-949813ab>Shift Hours Management</h1></div><div class="shift-hours-table-wrap" data-v-949813ab>`);
      if (isLoadingShifts.value) {
        _push(`<div class="loading-state" data-v-949813ab><div class="spinner" data-v-949813ab></div><p class="loading-text" data-v-949813ab>Loading shift hours...</p></div>`);
      } else {
        _push(`<table class="shift-hours-table" data-v-949813ab><thead data-v-949813ab><tr data-v-949813ab><th data-v-949813ab>Shift Start</th><th data-v-949813ab>Shift End</th><th class="actions-column" data-v-949813ab>Action</th></tr></thead><tbody data-v-949813ab>`);
        if (shifts.value.length === 0) {
          _push(`<tr data-v-949813ab><td colspan="4" class="empty-state" data-v-949813ab> No shift hours records found. </td></tr>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<!--[-->`);
        serverRenderer_cjs_prodExports.ssrRenderList(shifts.value, (shift) => {
          _push(`<tr data-v-949813ab><td data-v-949813ab>${serverRenderer_cjs_prodExports.ssrInterpolate(formatTimeTo12Hour(shift.start))}</td><td data-v-949813ab>${serverRenderer_cjs_prodExports.ssrInterpolate(formatTimeTo12Hour(shift.end))}</td><td data-v-949813ab><div class="action-buttons" data-v-949813ab><button class="delete-icon-button" aria-label="Delete shift" data-v-949813ab>`);
          _push(serverRenderer_cjs_prodExports.ssrRenderComponent(vueExports.unref(TrashIcon), { class: "delete-icon" }, null, _parent));
          _push(`</button></div></td></tr>`);
        });
        _push(`<!--]--></tbody></table>`);
      }
      _push(`</div><button class="floating-button" data-v-949813ab>`);
      ...
      _push(serverRenderer_cjs_prodExports.ssrRenderComponent(Modal, {
        ...
        footer: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="modal-footer-content" data-v-949813ab${_scopeId}><button class="modal-button modal-button--subtle-red" data-v-949813ab${_scopeId}> Cancel </button><button class="modal-button modal-button--subtle-blue" data-v-949813ab${_scopeId}> Add Shifts </button></div>`);
          } else {
            return [
        ...
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="modal-content" data-v-949813ab${_scopeId}><div class="shift-section" data-v-949813ab${_scopeId}><h3 class="shift-section-title" data-v-949813ab${_scopeId}>Morning Shift (AM only)</h3><div class="form-group" data-v-949813ab${_scopeId}><label class="form-label" data-v-949813ab${_scopeId}>Time In</label><input${serverRenderer_cjs_prodExports.ssrRenderAttr("value", morningShiftTimeIn.value)} type="time" class="${serverRenderer_cjs_prodExports.ssrRenderClass([{ "time-input--error": morningShiftError.value }, "time-input"])}" data-v-949813ab${_scopeId}>`);
            if (morningShiftError.value) {
              _push2(`<p class="error-message" data-v-949813ab${_scopeId}>${serverRenderer_cjs_prodExports.ssrInterpolate(morningShiftError.value)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="form-group" data-v-949813ab${_scopeId}><label class="form-label" data-v-949813ab${_scopeId}>Time Out</label><input${serverRenderer_cjs_prodExports.ssrRenderAttr("value", morningShiftTimeOut.value)} type="time" class="time-input time-input--disabled" disabled data-v-949813ab${_scopeId}></div></div><div class="shift-section" data-v-949813ab${_scopeId}><h3 class="shift-section-title" data-v-949813ab${_scopeId}>Afternoon Shift (PM only)</h3><div class="form-group" data-v-949813ab${_scopeId}><label class="form-label" data-v-949813ab${_scopeId}>Time In</label><input${serverRenderer_cjs_prodExports.ssrRenderAttr("value", afternoonShiftTimeIn.value)} type="time" class="${serverRenderer_cjs_prodExports.ssrRenderClass([{ "time-input--error": afternoonShiftError.value }, "time-input"])}" data-v-949813ab${_scopeId}>`);
            if (afternoonShiftError.value) {
              _push2(`<p class="error-message" data-v-949813ab${_scopeId}>${serverRenderer_cjs_prodExports.ssrInterpolate(afternoonShiftError.value)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="form-group" data-v-949813ab${_scopeId}><label class="form-label" data-v-949813ab${_scopeId}>Time Out</label><input${serverRenderer_cjs_prodExports.ssrRenderAttr("value", afternoonShiftTimeOut.value)} type="time" class="time-input time-input--disabled" disabled data-v-949813ab${_scopeId}></div></div></div>`);
          } else {
            return [
      ...
      _push(serverRenderer_cjs_prodExports.ssrRenderComponent(Modal, {
        ...
        footer: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="modal-footer-content" data-v-949813ab${_scopeId}><button class="modal-button modal-button--subtle-red" data-v-949813ab${_scopeId}> Cancel </button><button class="modal-button modal-button--subtle-blue" data-v-949813ab${_scopeId}> Confirm </button></div>`);
          } else {
            return [
              vueExports.createVNode("div", { class: "modal-footer-content" }, [
                vueExports.createVNode("button", {
        ...
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="confirmation-content" data-v-949813ab${_scopeId}><p class="confirmation-text" data-v-949813ab${_scopeId}>Add these shifts?</p><div class="shift-details" data-v-949813ab${_scopeId}><div class="detail-section" data-v-949813ab${_scopeId}><h4 class="detail-section-title" data-v-949813ab${_scopeId}>Morning Shift</h4><div class="detail-row" data-v-949813ab${_scopeId}><span data-v-949813ab${_scopeId}>Time In:</span><span data-v-949813ab${_scopeId}>${serverRenderer_cjs_prodExports.ssrInterpolate(formatTimeTo12Hour(morningShiftTimeIn.value))}</span></div><div class="detail-row" data-v-949813ab${_scopeId}><span data-v-949813ab${_scopeId}>Time Out:</span><span data-v-949813ab${_scopeId}>${serverRenderer_cjs_prodExports.ssrInterpolate(formatTimeTo12Hour(morningShiftTimeOut.value))}</span></div></div><div class="detail-section" data-v-949813ab${_scopeId}><h4 class="detail-section-title" data-v-949813ab${_scopeId}>Afternoon Shift</h4><div class="detail-row" data-v-949813ab${_scopeId}><span data-v-949813ab${_scopeId}>Time In:</span><span data-v-949813ab${_scopeId}>${serverRenderer_cjs_prodExports.ssrInterpolate(formatTimeTo12Hour(afternoonShiftTimeIn.value))}</span></div><div class="detail-row" data-v-949813ab${_scopeId}><span data-v-949813ab${_scopeId}>Time Out:</span><span data-v-949813ab${_scopeId}>${serverRenderer_cjs_prodExports.ssrInterpolate(formatTimeTo12Hour(afternoonShiftTimeOut.value))}</span></div></div></div></div>`);
          } else {
            return [
      ...
      _push(serverRenderer_cjs_prodExports.ssrRenderComponent(Modal, {
        ...
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="delete-modal" data-v-949813ab${_scopeId}><p class="delete-modal__text" data-v-949813ab${_scopeId}>Are you sure you want to delete this shift hour?</p>`);
            if (pendingDeleteShiftRange.value) {
              _push2(`<p class="delete-modal__range" data-v-949813ab${_scopeId}>${serverRenderer_cjs_prodExports.ssrInterpolate(pendingDeleteShiftRange.value)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<div class="delete-modal__actions" data-v-949813ab${_scopeId}><button class="delete-modal__button delete-modal__button--subtle-red" data-v-949813ab${_scopeId}> No </button><button class="delete-modal__button delete-modal__button--subtle-blue" data-v-949813ab${_scopeId}> Yes, Delete </button></div></div>`);
          } else {
            return [
      ...
      _push(serverRenderer_cjs_prodExports.ssrRenderComponent(Modal, {
        ...
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="loading-content" data-v-949813ab${_scopeId}><div class="spinner" aria-hidden="true" data-v-949813ab${_scopeId}></div><p class="loading-text" data-v-949813ab${_scopeId}>${serverRenderer_cjs_prodExports.ssrInterpolate(loadingText.value)}</p></div>`);
          } else {
            return [
...
const ShiftHours = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-949813ab"]]);

export { ShiftHours as default };
//# sourceMappingURL=shift-hours-DseEWtFP.mjs.map
