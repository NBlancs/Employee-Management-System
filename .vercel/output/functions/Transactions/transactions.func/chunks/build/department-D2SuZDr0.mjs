...
const _sfc_main = /* @__PURE__ */ vueExports.defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${serverRenderer_cjs_prodExports.ssrRenderAttrs(vueExports.mergeProps({ class: "department-page" }, _attrs))} data-v-9db1703d><div class="top-alert-wrap" data-v-9db1703d>`);
      ...
      _push(`</div><h1 class="department-title" data-v-9db1703d>Department Management</h1><form class="department-search" data-v-9db1703d>`);
      ...
      _push(serverRenderer_cjs_prodExports.ssrRenderComponent(Button, {
        ...
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span data-v-9db1703d${_scopeId}>Search</span>`);
          } else {
            return [
      ...
      _push(`</form><div class="form-divider" aria-hidden="true" data-v-9db1703d></div><div class="departments-table-wrap" data-v-9db1703d><table class="departments-table"${serverRenderer_cjs_prodExports.ssrRenderAttr("aria-busy", isTableLoading.value ? "true" : "false")} data-v-9db1703d><thead data-v-9db1703d><tr data-v-9db1703d><th data-v-9db1703d>Department</th><th data-v-9db1703d>Department Head</th><th class="actions-column" data-v-9db1703d>Actions</th></tr></thead><tbody data-v-9db1703d>`);
      if (isTableLoading.value) {
        _push(`<tr class="loading-row" role="status" aria-live="polite" data-v-9db1703d><td class="loading-cell" colspan="4" data-v-9db1703d><div class="loading-content" data-v-9db1703d><span class="table-spinner" aria-hidden="true" data-v-9db1703d></span><span data-v-9db1703d>Loading departments...</span></div></td></tr>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<!--[-->`);
      serverRenderer_cjs_prodExports.ssrRenderList(isTableLoading.value ? [] : filteredDepartments.value, (department) => {
        _push(`<tr data-v-9db1703d><td data-v-9db1703d>${serverRenderer_cjs_prodExports.ssrInterpolate(department.name)}</td><td data-v-9db1703d>${serverRenderer_cjs_prodExports.ssrInterpolate(department.head)}</td><td data-v-9db1703d><div class="action-buttons" data-v-9db1703d><button type="button" class="action-button action-button--view"${serverRenderer_cjs_prodExports.ssrRenderAttr("aria-label", `View ${department.name}`)} data-v-9db1703d>`);
        _push(serverRenderer_cjs_prodExports.ssrRenderComponent(vueExports.unref(EyeIcon), { class: "action-icon" }, null, _parent));
        _push(`</button><button type="button" class="action-button action-button--delete"${serverRenderer_cjs_prodExports.ssrRenderAttr("aria-label", `Delete ${department.name}`)} data-v-9db1703d>`);
      ...
      if (!isTableLoading.value && !filteredDepartments.value.length) {
        _push(`<tr data-v-9db1703d><td colspan="4" class="empty-state" data-v-9db1703d>No departments found.</td></tr>`);
      } else {
        _push(`<!---->`);
      }
      ...
      _push(serverRenderer_cjs_prodExports.ssrRenderComponent(Modal, {
        ...
        header: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="modal-header-wrap" data-v-9db1703d${_scopeId}><h3 class="modal-title" data-v-9db1703d${_scopeId}>New Department</h3></div>`);
          } else {
            return [
        ...
        footer: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<button type="button" class="app-modal__btn app-modal__btn--ghost" data-v-9db1703d${_scopeId}> Cancel </button><button type="button" class="app-modal__btn app-modal__btn--primary" data-v-9db1703d${_scopeId}> Add Department </button>`);
          } else {
            return [
        ...
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="modal-form-field" data-v-9db1703d${_scopeId}><label class="modal-field-label" for="new-department-name" data-v-9db1703d${_scopeId}>Enter Department name</label>`);
            ...
            if (hasDepartmentNameError.value) {
              _push2(`<p class="modal-field-error" data-v-9db1703d${_scopeId}>Please enter department name</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div>`);
      ...
      _push(serverRenderer_cjs_prodExports.ssrRenderComponent(Modal, {
        ...
        footer: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<button type="button" class="app-modal__btn app-modal__btn--ghost confirm-modal-cancel-btn" data-v-9db1703d${_scopeId}> Cancel </button><button type="button" class="app-modal__btn app-modal__btn--primary confirm-modal-confirm-btn" data-v-9db1703d${_scopeId}> Confirm </button>`);
          } else {
            return [
              vueExports.createVNode("button", {
                type: "button",
        ...
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p class="confirm-modal-text" data-v-9db1703d${_scopeId}> Add <span class="confirm-modal-department-name" data-v-9db1703d${_scopeId}>${serverRenderer_cjs_prodExports.ssrInterpolate(newDepartmentName.value.trim())}</span> to the list? </p>`);
          } else {
            return [
      ...
      _push(serverRenderer_cjs_prodExports.ssrRenderComponent(Modal, {
        ...
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="loading-modal-content" role="status" aria-live="polite" data-v-9db1703d${_scopeId}><span class="table-spinner" aria-hidden="true" data-v-9db1703d${_scopeId}></span><p class="adding-department-text" data-v-9db1703d${_scopeId}>Adding new department</p></div>`);
          } else {
            return [
      ...
      _push(serverRenderer_cjs_prodExports.ssrRenderComponent(Modal, {
        ...
        footer: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="delete-modal-footer-content" data-v-9db1703d${_scopeId}><button type="button" class="app-modal__btn delete-modal-no-btn" data-v-9db1703d${_scopeId}> No </button><button type="button" class="app-modal__btn delete-modal-yes-btn" data-v-9db1703d${_scopeId}> Yes, Delete </button></div>`);
          } else {
            return [
        ...
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p class="delete-modal-text" data-v-9db1703d${_scopeId}> Are you sure you want to delete Department of <span class="confirm-modal-department-name" data-v-9db1703d${_scopeId}>${serverRenderer_cjs_prodExports.ssrInterpolate(departmentToDelete.value?.name || "this department")}</span>? </p>`);
          } else {
            return [
      ...
      _push(serverRenderer_cjs_prodExports.ssrRenderComponent(Modal, {
        ...
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="loading-modal-content" role="status" aria-live="polite" data-v-9db1703d${_scopeId}><span class="table-spinner" aria-hidden="true" data-v-9db1703d${_scopeId}></span><p class="deleting-department-text" data-v-9db1703d${_scopeId}>Deleting Department</p></div>`);
          } else {
            return [
              vueExports.createVNode("div", {
                class: "loading-modal-content",
...
const Department = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-9db1703d"]]);

export { Department as default };
//# sourceMappingURL=department-D2SuZDr0.mjs.map
