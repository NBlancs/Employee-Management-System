    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!__props.hideTrigger) {
        serverRenderer_cjs_prodExports.ssrRenderSlot(_ctx.$slots, "trigger", { open: openModal }, () => {
          _push(`<button type="button" class="app-modal__trigger" data-v-fdf5398a>${serverRenderer_cjs_prodExports.ssrInterpolate(__props.triggerLabel)}</button>`);
        }, _push, _parent);
      } else {
        _push(`<!---->`);
      }
      serverRenderer_cjs_prodExports.ssrRenderTeleport(_push, (_push2) => {
        if (open.value) {
          _push2(`<div class="app-modal__overlay" data-v-fdf5398a><div class="app-modal" role="dialog" aria-modal="true" data-v-fdf5398a>`);
          if (__props.title || __props.description || vueExports.unref(slots).header) {
            _push2(`<header class="app-modal__header" data-v-fdf5398a>`);
            serverRenderer_cjs_prodExports.ssrRenderSlot(_ctx.$slots, "header", {}, () => {
              if (__props.title) {
                _push2(`<h3 class="app-modal__title" data-v-fdf5398a>${serverRenderer_cjs_prodExports.ssrInterpolate(__props.title)}</h3>`);
              } else {
                _push2(`<!---->`);
              }
              if (__props.description) {
                _push2(`<p class="app-modal__description" data-v-fdf5398a>${serverRenderer_cjs_prodExports.ssrInterpolate(__props.description)}</p>`);
              } else {
                _push2(`<!---->`);
              }
            }, _push2, _parent);
          ...
          _push2(`<section class="app-modal__body" data-v-fdf5398a>`);
          serverRenderer_cjs_prodExports.ssrRenderSlot(_ctx.$slots, "default", {}, () => {
            _push2(`<p data-v-fdf5398a>Add your modal content here.</p>`);
          }, _push2, _parent);
          _push2(`</section>`);
          if (__props.showFooter || vueExports.unref(slots).footer) {
            _push2(`<footer class="app-modal__footer" data-v-fdf5398a>`);
            serverRenderer_cjs_prodExports.ssrRenderSlot(_ctx.$slots, "footer", {
              confirm: handleConfirm,
              cancel: handleCancel,
              close: closeModal
            }, () => {
              _push2(`<button type="button" class="app-modal__btn app-modal__btn--ghost" data-v-fdf5398a>${serverRenderer_cjs_prodExports.ssrInterpolate(__props.cancelLabel)}</button><button type="button" class="app-modal__btn app-modal__btn--primary" data-v-fdf5398a>${serverRenderer_cjs_prodExports.ssrInterpolate(__props.confirmLabel)}</button>`);
            }, _push2, _parent);
            _push2(`</footer>`);
          } else {
            _push2(`<!---->`);
...
const Modal = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main, [["__scopeId", "data-v-fdf5398a"]]), { __name: "Modal" });

export { Alert as A, Modal as M };
//# sourceMappingURL=Modal-gsHbAz6A.mjs.map
