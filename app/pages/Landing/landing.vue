      ...
      <div class="right-side">
        <Card title="Welcome Back" subtitle="Please enter your credentials to sign in.">
          ...
          <form class="login-form" method="post" @submit.prevent="onSubmit">
            ...
            <p v-if="loginStatusText" class="login-status-text login-status-text--error">
              {{ loginStatusText }}
            </p>
...
.scatter-pos-1 { top: 8%; left: 4%; }
.scatter-pos-2 { top: 20%; left: 26%; }
.scatter-pos-3 { top: 6%; right: 18%; }
.scatter-pos-4 { top: 28%; right: 2%; }
.scatter-pos-5 { top: 42%; left: 2%; }
.scatter-pos-6 { top: 56%; left: 20%; }
.scatter-pos-7 { top: 48%; right: 24%; }
.scatter-pos-8 { top: 60%; right: 4%; }
.scatter-pos-9 { bottom: 18%; left: 8%; }
.scatter-pos-10 { bottom: 6%; left: 30%; }
.scatter-pos-11 { bottom: 12%; right: 26%; }
.scatter-pos-12 { bottom: 4%; right: 6%; }
